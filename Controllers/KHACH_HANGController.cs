...
namespace newmoi2.Controllers
{
    public class KHACH_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KHACH_HANG_ID,HO_TEN,EMAIL,SODIENTHOAI,DIACHI,NGAY_DANG_KY,MAT_KHAU,TRANG_THAI")] KHACH_HANG kHACH_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KHACH_HANG_ID,HO_TEN,EMAIL,SODIENTHOAI,DIACHI,NGAY_DANG_KY,MAT_KHAU,TRANG_THAI")] KHACH_HANG kHACH_HANG)
        {
            if (ModelState.IsValid)
            {
